...
class SqueezeDet():
    ...
    def _create_model(self):
        ...
        fire4 = self._fire_layer(name='fire4', input = pool3, s1x1=32, e1x1=128, e3x3=128)

        fire5 = self._fire_layer(name='fire5', input = fire4, s1x1=32, e1x1=128, e3x3=128)

        pool5 = MaxPool2D(pool_size=(3, 3), strides=(2, 2), padding='SAME', name="pool5")(fire5)

        fire6 = self._fire_layer(name='fire6', input = pool5, s1x1=48, e1x1=192, e3x3=192)

        fire7 = self._fire_layer(name='fire7', input = fire6, s1x1=48, e1x1=192, e3x3=192)

        fire8 = self._fire_layer(name='fire8', input = fire7, s1x1=64, e1x1=256, e3x3=256)

        fire9 = self._fire_layer(name='fire9', input = fire8, s1x1=64, e1x1=256, e3x3=256)

        # Two extra fire modules that are not trained before
        fire10 = self._fire_layer(name='fire10', input = fire9, s1x1=96, e1x1=384, e3x3=384)

        fire11 = self._fire_layer(name='fire11', input = fire10, s1x1=96, e1x1=384, e3x3=384)
